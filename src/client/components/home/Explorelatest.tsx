...
function Explorelatest() {
   ...
   return (
      <>
         <div className="w-full  md:w-5/6  mx-auto  px-1 md:px-4 lg:mt-9 ">
            <h2 className="text-3xl py-4">Explore latest</h2>
                  ...
                  <div key={item.id} className=" rounded-t-[5px]  overflow-hidden transition-shadow duration-300 group">
                     ...
                     <div className="relative">
                        <img
                           ...
                           src={item.imageUrl || "https://i.ibb.co/BHDNbKBP/images.jpg"}
