...
function Recommended() {
   ...
   return (
      <>
         <div className="w-full md:max-w-7xl mx-auto px-1 md:px-4 h-screen">
            <h2 className="text-[20px] md:text-3xl py-4 mb-3">Recommended for you {products.length}</h2>
               ...
               <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-6">
                  {products.map((item) => (
                     <div key={item.id} className="rounded-t-[5px] overflow-hidden transition-shadow duration-300 group">
                        ...
                        <div className="p-5">
                           <h3 className="text-[10px] sm:text-lg font-semibold text-gray-800 mb-2 truncate">
                              {item.name}
                           </h3>
