...
const ErrorPage = () => {
  return (
    <>
      <div className=" py-10 bg-gray-100 dark:bg-gray-900 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-4 text-center">
          <div className="mb-4">
            <h2 className="mt-0 text-6xl font-extrabold text-gray-900 dark:text-gray-100">404</h2>
